      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 mb-6">
          <Card className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
            <CardHeader className="pb-2 pt-4 px-3 md:px-4">
              <div className="flex items-center justify-between">
                <CardTitle className="text-xs md:text-sm font-medium opacity-90">Total Clientes</CardTitle>
                <Users className="h-4 w-4 opacity-90" />
              </div>
            </CardHeader>
            <CardContent className="px-3 md:px-4 pb-4">
              <div className="text-lg md:text-2xl font-bold">{clientes.length}</div>
              <p className="text-xs opacity-90 mt-1">{clientesAtivos} ativos</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white">
            <CardHeader className="pb-2 pt-4 px-3 md:px-4">
              <div className="flex items-center justify-between">
                <CardTitle className="text-xs md:text-sm font-medium opacity-90">Com Vendas</CardTitle>
                <Users className="h-4 w-4 opacity-90" />
              </div>
            </CardHeader>
            <CardContent className="px-3 md:px-4 pb-4">
              <div className="text-lg md:text-2xl font-bold">{clientesComVendas}</div>
          ...
          <Card className="bg-gradient-to-r from-purple-500 to-purple-600 text-white">
            <CardHeader className="pb-2 pt-4 px-3 md:px-4">
              <div className="flex items-center justify-between">
                <CardTitle className="text-xs md:text-sm font-medium opacity-90">Total Vendas</CardTitle>
                <Users className="h-4 w-4 opacity-90" />
              </div>
            </CardHeader>
            <CardContent className="px-3 md:px-4 pb-4">
              <div className="text-lg md:text-2xl font-bold">{totalVendas}</div>
              <p className="text-xs opacity-90 mt-1">Todas as vendas</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-r from-orange-500 to-orange-600 text-white">
            <CardHeader className="pb-2 pt-4 px-3 md:px-4">
              <div className="flex items-center justify-between">
                <CardTitle className="text-xs md:text-sm font-medium opacity-90">Média/Cliente</CardTitle>
                <Users className="h-4 w-4 opacity-90" />
              </div>
            </CardHeader>
            <CardContent className="px-3 md:px-4 pb-4">
              <div className="text-lg md:text-2xl font-bold">
                {clientesComVendas > 0 ? (totalVendas / clientesComVendas).toFixed(1) : '0'}
              </div>
              <p className="text-xs opacity-90 mt-1">Vendas por cliente</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs defaultValue="lista" className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 h-auto">
            <TabsTrigger value="lista" className="text-xs md:text-sm py-2">
              Lista de Clientes
            </TabsTrigger>
            <TabsTrigger 
              value="historico" 
